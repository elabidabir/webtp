...
<html lang="fr">
    ...
    <body>		
		...
		if(isset($_POST['insert'])){
			...
			$sql = "INSERT INTO admin(`f_name`, `l_name`, `email`, `login`, `password`) VALUES (:firstname,:lastname,:email,:login,:password)";
			$res = $pdo->prepare($sql);
			...
			?>
				<div class="form">
					...
					<a href="#" class="btn btnMenu" onclick="window.location='http://localhost/tp_web/html/pageAdmin.php'">Se connecter sur la partie administrateur</a>
