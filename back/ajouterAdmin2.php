...
<html lang="fr">
    <head>
        ...
        <title>Ajouter user : BabyStyle</title>
    </head>
    <body>		
		<?php
		...
		if(isset($_POST['insert'])){
			...
			$sql = "INSERT INTO administrateur(`f_name`, `l_name`, `email`, `login`, `password`) VALUES (:firstname,:lastname,:email,:login,:password)";
			$res = $pdo->prepare($sql);
			...
			?>
				<div class="form">
					...
					<a href="#" class="btn btnMenu" onclick="window.location='http://localhost/tp_web/html/pageAdmin.php'">Continuer sur la partie admin</a>
