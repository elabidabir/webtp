...
<html lang="fr">
    <head>
        ...
        <title>login utilisateur : BabyStyle</title>
    ...
    <body>
        ...
        <div class="insc">
				<div class="loginForm">
					...
					<br><br>
					<form action="../back/utilisateur2.php" method="post" onsubmit="return ValidateFormForLoginEvent();">		
						<label>Login :</label>
						...
						<div class="valide">
							...
							<a href="#" class="btn" onclick="window.location='../html/registerUser.php'">Créer</a>
						</div>
					</form>
				</div>
		</div>
